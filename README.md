...
**Last sync:** 2026-08-18 from gittr `main` (examples prefer `relay.gittr.space` / `git.gittr.space`). SSH is laptop git to the bridge; **gittr-mcp uses HTTPS + nsec**, not SSH.
