...
| <span style="color: #8b5cf6;">[`snippets/markdown-media-handling/`](snippets/markdown-media-handling/README.md)</span> | Handle images, videos, and media in markdown files with API endpoint support | Resolves relative image paths, converts base64 API responses to data URLs, supports YouTube/Vimeo embeds, and handles relative links within repositories. |
